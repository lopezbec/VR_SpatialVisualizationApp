...

{
    ...
    public class VRCapture : MonoBehaviour
    {
        ...
        public bool RT2Video = false;

        public enum VRFormatList { JPG, PNG, EXR_HDRI, Direct };
        ...
        public bool playPanorama = false;
        GameObject vrPlayer;
        ...
        void Start()
        {
            ...
            if (PlayerPrefs.GetInt("VRPlayer", 0) == 0) playPanorama = false;
            ...
            if (playPanorama)
            {
                ...
                vrPlayer = (GameObject)Instantiate(Resources.Load("VRVideoPlayerRig"));
            ...
            else
            {
                ...
                if (disableTracking)
                {
                    gameObject.GetComponent<Camera>().stereoTargetEye = StereoTargetEyeMask.None;
                }
        ...
        void LateUpdate()
        {
            ...
            {
                screenShot = GetScreenshotHQ(true);
            }
        ...
        public void SaveScreenshot()
        {
            ...
            else if (ImageFormatType == VRFormatList.EXR_HDRI)
            {
                ...
                if (captureType == VRCaptureList.StillImage) timestamp = System.DateTime.Now.Ticks + "Screenshot";
                string filePathf = string.Format(fullPath + _prefix + "{1:D05}" + timestamp + ".exr", Folder, (Time.frameCount - StartFrame - 1));
                formatString = ".exr\"";
                StartCoroutine(SaveFileEXRNew(filePathf, screenShot));
            }
        }
        ...
        public void PreparePano()
        {
            ...
            cam.GetComponent<Camera>().cullingMask = ~(1 << 11);
